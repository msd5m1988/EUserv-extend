...
USERNAME = 'chimjeffrey@gmail.com'  # 这里填用户名，邮箱也可
PASSWORD = '8ew!WKF3rLAFfzQ'  # 这里填密码

# TrueCaptcha https://apitruecaptcha.org
# 验证码识别，默认使用 Demo API，每天有100次免费额度，建议自行注册以确保稳定性
TRUECAPTCHA_USERID = 'JeffreyChim'
TRUECAPTCHA_APIKEY = 'zxEOYVqw0eWvYM65TsCd'
TRUECAPTCHA_CHECK_USAGE = True


# Telegram Bot Push https://core.telegram.org/bots/api#authorizing-your-bot
TG_BOT_TOKEN = '6327006688:AAHvZHZTxDcc7kk3oBprg1Bz3LDJ86xc-OA'  # 通过 @BotFather 申请获得，示例：1077xxx4424:AAFjv0FcqxxxxxxgEMGfi22B4yh15R5uw
TG_USER_ID = '6305055244'  # 用户、群组或频道 ID，示例：129xxx206
